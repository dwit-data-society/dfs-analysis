...
<style>
    ...
    .subtitle { color: var(--text-color); opacity: 0.8; font-size: 14px; font-weight: 300; margin-top: -10px; }
    .narrative-text { color: var(--text-color); font-size: 16px; line-height: 1.8; text-align: justify; margin: 1.5rem 0; }
</style>
...
st.markdown("<p style='text-align: center; color: var(--text-color); opacity: 0.8; font-size: 18px;'>Unpacking Canteen Sales</p>", unsafe_allow_html=True)
st.markdown("---")
...
with col1:
    ...
    fig_top.update_layout(title="Top 10 Items by Revenue", xaxis_title="Revenue (NPR)", yaxis_title="", height=400, font=dict(family='Roboto', size=12), xaxis=dict(showgrid=True), yaxis=dict(showgrid=False, autorange="reversed"), margin=dict(r=20, l=10, t=50, b=50))
...
with col2:
    ...
    fig_bottom.update_layout(title="Bottom 10 Items by Revenue (min 5 orders)", xaxis_title="Revenue (NPR)", yaxis_title="", height=400, font=dict(family='Roboto', size=12), xaxis=dict(showgrid=True), yaxis=dict(showgrid=False, autorange="reversed"), margin=dict(r=20, l=10, t=50, b=50))
...
with col1:
    ...
    fig_hourly.update_layout(title="Orders by Hour of Day", xaxis_title="Hour", yaxis_title="Number of Orders", height=350, font=dict(family='Roboto', size=12), xaxis=dict(showgrid=False, dtick=1), yaxis=dict(showgrid=True))
    st.plotly_chart(fig_hourly, use_container_width=True)

with col2:
    fig_daily = go.Figure()
    fig_daily.add_trace(go.Bar(x=DAILY_DAYS, y=DAILY_ORDERS, marker=dict(color=COLORS['secondary'])))
    fig_daily.update_layout(title="Orders by Day of Week", xaxis_title="", yaxis_title="Number of Orders", height=350, font=dict(family='Roboto', size=12), xaxis=dict(showgrid=False), yaxis=dict(showgrid=True))
...
with col1:
    ...
    fig_fulfill.update_layout(title="Order Fulfillment Time Distribution", xaxis_title="Minutes", yaxis_title="Number of Orders", height=350, font=dict(family='Roboto', size=12), xaxis=dict(showgrid=True), yaxis=dict(showgrid=True))
...
with col2:
    ...
    fig_success.update_layout(title="Delivery Success Rate by Hour", xaxis_title="Hour", yaxis_title="Success Rate (%)", height=350, font=dict(family='Roboto', size=12), xaxis=dict(showgrid=False, dtick=1), yaxis=dict(showgrid=True, range=[0, 100]))
...
with col1:
    ...
    fig_price.update_layout(title="Order Distribution by Price Category", xaxis_title="", yaxis_title="Number of Orders", height=350, font=dict(family='Roboto', size=12), xaxis=dict(showgrid=False), yaxis=dict(showgrid=True))
...
with col2:
    ...
    fig_monthly_price.update_layout(title="Revenue Composition Over Time", xaxis_title="", yaxis_title="Revenue (NPR)", height=350, font=dict(family='Roboto', size=12), hovermode='x unified', xaxis=dict(showgrid=False), yaxis=dict(showgrid=True))
...
with col2:
    ...
    fig_churn.update_layout(title="Active Customers per Week", xaxis_title="Week", yaxis_title="Active Customers", height=350, font=dict(family='Roboto', size=12), xaxis=dict(showgrid=False), yaxis=dict(showgrid=True))
...
fig_forecast.update_layout(title="Revenue Forecast (Next 30 Days)", xaxis_title="Date", yaxis_title="Revenue (NPR)", height=400, font=dict(family='Roboto', size=12), hovermode='x unified', xaxis=dict(showgrid=True), yaxis=dict(showgrid=True), legend=dict(orientation="h", yanchor="bottom", y=1.02, xanchor="right", x=1))
...
with col2:
    ...
    fig_cancel.update_layout(title="Cancellation Rate by Hour", xaxis_title="Hour of Day", yaxis_title="Cancellation Rate (%)", height=300, font=dict(family='Roboto', size=12), xaxis=dict(showgrid=False, dtick=1), yaxis=dict(showgrid=True, range=[0, 10]))
...
fig_item_cancel.update_layout(title="Top 10 Items by Cancellation Rate (min 5 orders)", xaxis_title="Cancellation Rate (%)", yaxis_title="", height=400, font=dict(family='Roboto', size=12), xaxis=dict(showgrid=True), yaxis=dict(showgrid=False, autorange="reversed"))
...
with col2:
    ...
    fig_lorenz.update_layout(title="Lorenz Curve - Revenue Distribution", xaxis_title="Cumulative % of Customers", yaxis_title="Cumulative % of Revenue", height=400, font=dict(family='Roboto', size=12), xaxis=dict(showgrid=True, range=[0, 100]), yaxis=dict(showgrid=True, range=[0, 100]), legend=dict(orientation="h", yanchor="bottom", y=1.02, xanchor="right", x=1))
...
with col1:
    ...
    fig_tier_count.update_layout(title="Customer Distribution by Value Tier", xaxis_title="", yaxis_title="% of Customers", height=350, font=dict(family='Roboto', size=12), xaxis=dict(showgrid=False), yaxis=dict(showgrid=True))
...
with col2:
    ...
    fig_tier_revenue.update_layout(title="Revenue Contribution by Value Tier", xaxis_title="", yaxis_title="% of Revenue", height=350, font=dict(family='Roboto', size=12), xaxis=dict(showgrid=False), yaxis=dict(showgrid=True))
